...
%   varargin{1}:cell array of reference structure names, color, and volume.  
%       See LoadReferenceStructures for more information.
...
stats = cell(length(varargin{1}), 5);
...
for i = 1:length(varargin{1})
    ...
    stats{i,1} = sprintf(['<html><font id="%s" color="rgb(%i,%i,%i)"', ...
        ...
        varargin{1}{i}.color(1), ...
        varargin{1}{i}.color(2), ...
        varargin{1}{i}.color(3), ...
        varargin{1}{i}.name);
